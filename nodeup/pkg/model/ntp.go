...
func (b *NTPBuilder) Build(c *fi.ModelBuilderContext) error {
	...
	case distros.DistributionContainerOS:
		glog.Infof("Detected ContainerOS; won't install ntp")
		return nil
	case distros.DistributionCoreOS:
		glog.Infof("Detected CoreOS; won't install ntp")
		return nil
	}
	...
	if b.Distribution.IsDebianFamily() {
		...
		glog.Warningf("unknown distribution, skipping ntp install: %v", b.Distribution)
		return nil
	}
