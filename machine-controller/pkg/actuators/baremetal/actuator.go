...
func NewActuator(conf *config.Configuration, clientset simple.Clientset, machineClient client.MachinesInterface) (*BaremetalActuator, error) {
	...
	return &BaremetalActuator{
		...
		sshCreds: SshCreds{
			...
			privateKeyPath: conf.SshPrivateKeyPath,
		},
